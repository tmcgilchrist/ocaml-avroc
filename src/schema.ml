...
let avro_schema_string = foreign "avro_schema_string" (void @-> returning avro_schema_t)

let avro_schema_bytes = foreign "avro_schema_bytes" (void @-> returning avro_schema_t)

let avro_schema_int = foreign "avro_schema_int" (void @-> returning avro_schema_t)

let avro_schema_long = foreign "avro_schema_long" (void @-> returning avro_schema_t)

let avro_schema_float = foreign "avro_schema_float" (void @-> returning avro_schema_t)

let avro_schema_double = foreign "avro_schema_double" (void @-> returning avro_schema_t)

let avro_schema_boolean = foreign "avro_schema_boolean" (void @-> returning avro_schema_t)

let avro_schema_null = foreign "avro_schema_null" (void @-> returning avro_schema_t)
...
let avro_schema_record_field_name =
  foreign "avro_schema_record_field_name" (avro_schema_t @-> int @-> returning string)

let avro_schema_record_field_get_index =
  foreign "avro_schema_record_field_get_index" (avro_schema_t @-> string @-> returning int)
...
let avro_schema_enum = foreign "avro_schema_enum" (string @-> returning avro_schema_t)

let avro_schema_enum_get =
  foreign "avro_schema_enum_get" (avro_schema_t @-> int @-> returning string)

let avro_schema_enum_get_by_name =
  foreign "avro_schema_enum_get_by_name" (avro_schema_t @-> string @-> returning int)

let avro_schema_enum_symbol_append =
  foreign "avro_schema_enum_symbol_append" (avro_schema_t @-> string @-> returning int)
...
let avro_schema_map = foreign "avro_schema_map" (avro_schema_t @-> returning avro_schema_t)
...
let avro_schema_union = foreign "avro_schema_union" (void @-> returning avro_schema_t)

let avro_schema_union_size =
  foreign "avro_schema_union_size" (avro_schema_t @-> returning size_t)

let avro_schema_union_append =
  foreign "avro_schema_union_append" (avro_schema_t @-> avro_schema_t @-> returning int)

let avro_schema_union_branch =
  foreign "avro_schema_union_branch" (avro_schema_t @-> int @-> returning avro_schema_t)
...
let avro_schema_from_json_literal schema_str schema =
  avro_schema_from_json_length
    schema_str
    (Unsigned.Size_t.of_int (String.length schema_str))
    schema
...
let avro_schema_name = foreign "avro_schema_name" (avro_schema_t @-> returning string)
...
let avro_schema_equal =
  foreign "avro_schema_equal" (avro_schema_t @-> avro_schema_t @-> returning int)

let avro_schema_incref =
  foreign "avro_schema_incref" (avro_schema_t @-> returning avro_schema_t)

let avro_schema_decref = foreign "avro_schema_decref" (avro_schema_t @-> returning int)

let avro_schema_match =
  foreign "avro_schema_match" (avro_schema_t @-> avro_schema_t @-> returning int)
