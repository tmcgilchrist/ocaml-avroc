...
let avro_value : avro_value structure typ = structure "avro_value"
...
let avro_value_iface : avro_value_iface structure typ = structure "avro_value_iface"
...
let avro_value_self = field avro_value "self" (ptr void)
...
let avro_value_iface_incref_iface =
  field
    avro_value_iface
    "incref_iface"
    (funptr (ptr avro_value_iface @-> returning (ptr avro_value_iface)))
...
let avro_value_iface_incref =
  field avro_value_iface "incref" (funptr (ptr avro_value_t @-> returning void))

let avro_value_iface_decref =
  field avro_value_iface "decref" (funptr (ptr avro_value_t @-> returning void))
...
let avro_value_iface_get_type =
  field
    avro_value_iface
    "get_type"
    (funptr (ptr avro_value_iface_t @-> ptr void @-> returning avro_type_t))

let avro_value_iface_get_schema =
  field
    avro_value_iface
    "get_schema"
    (funptr (ptr avro_value_iface_t @-> ptr void @-> returning avro_schema_t))
...
let avro_value_iface_set_bytes =
  field
    ...
    "set_bytes"
    (funptr
       (ptr avro_value_iface_t @-> ptr void @-> ptr void @-> size_t @-> returning int))
...
let avro_value_iface_set_branch =
  field
    ...
    "set_branch"
    (funptr
       (ptr avro_value_iface_t @-> ptr void @-> int @-> ptr avro_value_t @-> returning int))

let () = seal avro_value_iface

let avro_value_incref = foreign "avro_value_incref" (ptr avro_value_t @-> returning void)

let avro_value_decref = foreign "avro_value_incref" (ptr avro_value_t @-> returning void)

let avro_value_copy_ref =
  foreign "avro_value_copy_ref" (ptr avro_value_t @-> ptr avro_value_t @-> returning void)

let avro_value_move_ref =
  foreign "avro_value_move_ref" (ptr avro_value_t @-> ptr avro_value_t @-> returning void)

let avro_value_equal =
  foreign "avro_value_equal" (ptr avro_value_t @-> ptr avro_value_t @-> returning int)

let avro_value_equal_fast =
  foreign "avro_value_equal_fast" (ptr avro_value_t @-> ptr avro_value_t @-> returning int)

let avro_value_cmp =
  foreign "avro_value_cmp" (ptr avro_value_t @-> ptr avro_value_t @-> returning int)

let avro_value_cmp_fast =
  foreign "avro_value_cmp_fast" (ptr avro_value_t @-> ptr avro_value_t @-> returning int)

let avro_value_copy =
  foreign "avro_value_copy" (ptr avro_value_t @-> ptr avro_value_t @-> returning int)

let avro_value_copy_fast =
  foreign "avro_value_copy_fast" (ptr avro_value_t @-> ptr avro_value_t @-> returning int)

let avro_value_hash = foreign "avro_value_hash" (ptr avro_value_t @-> returning uint32_t)

let avro_value_to_json =
  foreign "avro_value_to_json" (ptr avro_value_t @-> int @-> ptr string @-> returning int)
...
let avro_value_reset value = get_method value avro_value_iface_reset

let avro_value_get_boolean value out = get_method value avro_value_iface_get_boolean out
...
let avro_value_get_double value out = get_method value avro_value_iface_get_double out

(*
#define avro_value_get_float(value, out) \
    avro_value_call(value, get_float, EINVAL, out)
  *)
let avro_value_get_float value out = get_method value avro_value_iface_get_float out

(*
#define avro_value_get_int(value, out) \
    avro_value_call(value, get_int, EINVAL, out)
*)
let avro_value_get_int value out = get_method value avro_value_iface_get_int out

(*
#define avro_value_get_long(value, out) \
    avro_value_call(value, get_long, EINVAL, out)
  *)
let avro_value_get_long value out = get_method value avro_value_iface_get_long out
...
let avro_value_get_enum value out = get_method value avro_value_iface_get_enum out
...
let avro_value_set_boolean value out = get_method value avro_value_iface_set_boolean out
...
*)
let avro_value_set_double value out = get_method value avro_value_iface_set_double out

(*
#define avro_value_set_float(value, val) \
    avro_value_call(value, set_float, EINVAL, val)
  *)
let avro_value_set_float value out = get_method value avro_value_iface_set_float out

(*
#define avro_value_set_int(value, val) \
    avro_value_call(value, set_int, EINVAL, val)
*)
let avro_value_set_int value out = get_method value avro_value_iface_set_int out

(*
#define avro_value_set_long(value, val) \
    avro_value_call(value, set_long, EINVAL, val)
  *)
let avro_value_set_long value out = get_method value avro_value_iface_set_long out

(*
#define avro_value_set_null(value) \
    avro_value_call0(value, set_null, EINVAL)
*)
let avro_value_set_null value = get_method value avro_value_iface_set_null

(*#define avro_value_set_string(value, str) \
    avro_value_call(value, set_string, EINVAL, str)*)
let avro_value_set_string value out = get_method value avro_value_iface_set_string out
...
let avro_value_set_enum value out = get_method value avro_value_iface_set_enum out
...
let avro_value_get_size value out = get_method value avro_value_iface_get_size out
